 ...
 * Image
 *
 * @ORM\Table(name="image_training")
 * @ORM\Entity(repositoryClass="WKT\PlatformBundle\Repository\ImageRepository")
    ...
    */
    ...
    public function upload()
    {
        ...
        if (null !== $this->tempFilename) {
            $oldFile = $this->getUploadRootDir().'/miniature'.$this->id.'.'.$this->tempFilename;
    ...
    protected function resizeImg($image){
        ...
        $destination = imagecreatetruecolor(150 * $ratio, 150); // On crée la photo redimensionnée
        ...
        return imagejpeg($destination, 'images/training/miniature' . $this->id . '.jpeg');
    }
}
