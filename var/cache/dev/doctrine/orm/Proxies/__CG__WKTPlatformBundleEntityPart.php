 ...
 */
class Part extends \WKT\PlatformBundle\Entity\Part implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WKT\\PlatformBundle\\Entity\\Part' . "\0" . 'id', '' . "\0" . 'WKT\\PlatformBundle\\Entity\\Part' . "\0" . 'title', '' . "\0" . 'WKT\\PlatformBundle\\Entity\\Part' . "\0" . 'articles'];
        }
