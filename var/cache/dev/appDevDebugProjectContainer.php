...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' => 'get182c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService',
            '2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' => 'get282c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService',
        ...
        $this->privates = array(
            '1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' => true,
            '2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a']) ? $this->services['1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a'] : $this->get182c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a']) ? $this->services['2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a'] : $this->get282c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'wikitech', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/WKT/PlatformBundle/Entity'))), 'WKT\\PlatformBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('WKTPlatformBundle' => 'WKT\\PlatformBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d6d6ba85194bc77d8a74189d0e4952c26e54839c4d6a188ad66151eb6726e793');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WKT/PlatformBundle/Resources/views'), 'WKTPlatform');
        $instance->addPath(($this->targetDirs[3].'/src/WKT/CoreBundle/Resources/views'), 'WKTCore');
    ...
    /**
     * Gets the private '1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get182c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService()
    {
        return $this->services['1_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get282c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36aService()
    {
        return $this->services['2_82c9ba88fb20aa3ba01e132e415ae64778e3aca122b4000c52d135bd1fd5e36a'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VJWOvW0KmC', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fLaEjnOwte', 0, '6v7yB185b6Hc6xBsYpaDZE', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B3Drd2s-Kf', 0, '6v7yB185b6Hc6xBsYpaDZE', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5bNY4Acecb', 0, '6v7yB185b6Hc6xBsYpaDZE', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59958abc3e5958.02314285');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WKTPlatformBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WKT/PlatformBundle'),
                    'namespace' => 'WKT\\PlatformBundle',
                ),
                'WKTCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WKT/CoreBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WKTPlatformBundle' => 'WKT\\PlatformBundle\\WKTPlatformBundle',
                'WKTCoreBundle' => 'WKT\\CoreBundle\\WKTCoreBundle',
            ...
            'stfalcon_tinymce.config' => array(
                'theme' => array(
                    'simple' => array(
                        ...
                        'toolbar1' => 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | forecolor emoticons',
                        'style_formats' => array(
                            0 => array(
                                'title' => 'Titre 1',
                                'block' => 'h2',
